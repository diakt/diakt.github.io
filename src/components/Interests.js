            ...
            <div class="mid-child">
                ...
                <ul class="interests-list">
                    <article class="interest-class">
                        <img class="interest-image" src="images/chopper-burn-norcal.jpg" altID="A slithery little friend" />
                    ...
                    <article class="interest-class">
                        <img class="interest-image" src="images/mpb.jpg" altID="A mountain pine beetle" />
                        <div class="encapsulation">
                    ...
                    <article class="interest-class">
                        <img class="interest-image" src="images/EARC_heat.JPG" altID="Rowing in a shell, dressed like an idiot." />
                        <div class="encapsulation">
                    ...
                    <article class="interest-class">
                        <img class="interest-image" src="images/EARC-champs.JPG" altID="EARC champions" />
                        <div class="encapsulation">
