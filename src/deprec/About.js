    ...
    return (
        <div className='ABOUT-main'>
            ...
            <div class="mid-child">
                ...
                <p class="inner-text">I began to love mathematics at Columbia, and my favorite coursework so far has been in Real Analysis, Markov Chain theory, and Probability theory. I rowed lightweight throughout and somehow won a national championship at one point. I worked odd jobs throughout school and was a vice president of the oddest residence hall at Columbia, Wien Hall.</p>
                <p class="inner-text">When the pandemic started, I decided to <s>drop out</s> wildland firefight out of PatRick Environmental’s base in Ellensburg, Washington. I enjoyed the work immensely. After the fire season ended, I worked at Zwift in a research role before returning to Columbia to study for my senior year.</p>
